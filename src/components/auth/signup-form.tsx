...
import { SignupFormSchema, signupFormSchema } from '@/lib/validations/auth-validation'
  ...
  return (
    <Form {...form}>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormControl>
                <div className="relative">
                  <Input
                    ...
                    autoComplete="name"
                  />
                  <FaIdCard className="absolute top-1/2 left-3 size-4 -translate-y-1/2 text-gray-500" />
                </div>
              </FormControl>
              <FormMessage />
            </FormItem>
              ...
              <FormControl>
                <div className="relative">
                  <Input
                    ...
                    autoComplete="new-password"
                  />
                  <FaCheckDouble className="absolute top-1/2 left-3 size-4 -translate-y-1/2 text-gray-500" />
                  <div
        ...
        <Button
          type="submit"
          className="h-11 w-full cursor-pointer font-bold text-foreground duration-300 hover:-translate-y-0.5"
