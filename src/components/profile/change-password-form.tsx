...
import { changePasswordSchema, ChangePasswordSchema } from '@/lib/validations/auth-validation'
...
const ChangePasswordForm = () => {
  ...
  return (
    <div className="card-hover overflow-hidden rounded-xl border bg-card shadow-md">
      <div className="p-6">
